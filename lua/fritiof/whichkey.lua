...
local mappings = {
	...
	g = {
		...
		["ö"] = { "<cmd>lua require 'gitsigns'.blame_line()<cr>", "Blame" },
	...
	s = {
		...
		p = { "<cmd>SessionManager load_last_session<cr>", "Load Last" },
		s = { "<cmd>SessionManager save_current_session<cr>", "Save Current" },
